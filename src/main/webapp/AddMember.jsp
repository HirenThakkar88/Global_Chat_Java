...
try (Connection conn = DBUtil.getConnection()) {
    ...
    String sql = "SELECT id, full_name, profile_pic FROM users WHERE id NOT IN " +
                "(SELECT user_id FROM group_members WHERE group_id = ?) AND id != ?";
...
<div class="container min-h-screen p-4 bg-base-100">
    <div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold mb-4">Add Members to Group</h1>
        ...
        <form action="AddMemberServlet" method="post">
            ...
            <button type="submit" 
                    class="w-full bg-neutral text-neutral-content px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors">
...
<script>
    ...
    function connectWebSocket() {
        ...
        ws.onopen = function() {
            console.log("WebSocket connected from Add Member Page");
